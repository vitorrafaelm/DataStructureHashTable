package api.storage.database.outerChain;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        VehicleOuterChainHash<Vehicles> t = new VehicleOuterChainHash<Vehicles>(50);
        DriverOuterChainHash<Drivers> d = new DriverOuterChainHash<>(50);
...
//        VehicleOuterChainNode item1 = t.search(randomNumber1);
//        VehicleOuterChainNode item2= t.search(randomNumber2);
//
//        System.out.println(item1.value.toString());
//        System.out.println(item2.value.toString());
//
